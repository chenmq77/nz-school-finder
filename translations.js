...
const TRANSLATIONS = {
  ...
  data: {
    ...
    authority: {
      "State":                           { en: "State", cn: "公立学校" },
      "State : Integrated":              { en: "State : Integrated", cn: "公立整合学校" },
      "Private : Fully Registered":      { en: "Private", cn: "私立学校" },
      "Private : Provisionally Registered": { en: "Private", cn: "私立学校" },
